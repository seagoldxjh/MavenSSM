...
<body>
	...
	<div class="form">
		...
		<ul class="tab-group">
			<li class="tab active"><a href="#signup">管理员注册</a></li>
			<li class="tab"><a href="#login">管理员登录</a></li>
		</ul>
		...
		<div class="tab-content">
				...
				<form id="registerForm">
					<div class="top-row">
						<div class="field-wrap">
							...
							</label> <input type="text" required autocomplete="off" name="admNo" />
						</div>

						<div class="field-wrap">
							<label> 姓名<span class="req">*</span>
							</label> <input type="text" required autocomplete="off" name="admName" />
						</div>
					</div>
			...
			<div id="login">
				...
				<form action="<%=basePath%>loginAdmin" method="post">

					<div class="field-wrap">
						<label> 学号<span class="req">*</span>
						</label> <input type="number" required autocomplete="off" name="admNo" />
					</div>
						...
						<form class="form-horizontal">
							...
							<div class="form-group">
								<div class="col-sm-6 col-sm-offset-3">
									<input id="admNo" name="admNo" class="form-control"
										placeholder="学号">
								</div>
							</div>
		...
		<script type="text/javascript">
			...
			$("#btn").click(function(){
				...
				var pwd = $("#pwd").val();
				var pwd2 = $("#pwd2").val();
				if(!re.test(admNo) || admNo=="" || pwd=="" || pwd==""){
					alert("学号只能为数字或没有填满所有字段!");
					return false;
				}else{
					$.ajax({
						url : "<%=basePath%>changePwdAdmin",
								data : "admNo=" + admNo + "&pwd=" + pwd
										+ "&pwd2=" + pwd2,
								type : "POST",
								success : function(result) {
									alert(result);
